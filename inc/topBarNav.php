...
<!-- Navbar -->
      ...
      <nav class="w-100 px-2 py-1 position-fixed top-0 bg-dark text-light" id="login-nav">
        <div class="d-flex justify-content-between w-100">
          <div>
            <span class="mr-2"><i class="fas fa-mobile-alt"></i> <?= $_settings->info('contact') ?></span>
          </div>
          <div>
            ...
            <?php endif; ?>
            <?php else: ?>
              <a href="./login" class="mx-2 text-light"><i class="fas fa-user-circle"></i> Войти в аккаунт </a>
            <?php endif; ?>
          </div>
        </div>
      </nav>
      <nav class="main-header navbar navbar-expand navbar-dark border-0 text-sm bg-gradient-navy" id='top-Nav'>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
              <li class="nav-item">
                <a href="./" class="nav-link <?= isset($page) && $page =='home' ? "active" : "" ?>"><i class="fas fa-hotel"></i> Главная </a>
              </li>
              <li class="nav-item">
                <a href="./?page=packages" class="nav-link <?= isset($page) && $page =='packages' ? "active" : "" ?>"><i class="fas fa-cubes"></i> Пакеты </a>
              </li>
              <li class="nav-item">
                <a href="./?page=events" class="nav-link <?= isset($page) && $page =='events' ? "active" : "" ?>"><i class="fas fa-pallet"></i> Мероприятия </a>
              </li>
              <li class="nav-item">
                <a href="./?page=about" class="nav-link <?= isset($page) && $page =='about' ? "active" : "" ?>"><i class="fas fa-house-user"></i> О компании </a>
              </li>
              <li class="nav-item">
                <a href="./?page=contact_us" class="nav-link <?= isset($page) && $page =='contact_us' ? "active" : "" ?>"><i class="fas fa-id-card"></i> Связаться с нами </a>
              </li>
            </ul>            
          </div>
          <!-- Right navbar links -->
