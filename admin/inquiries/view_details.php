...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <dl>
                <dt class="text-primary"><i class="fas fa-user-check"></i> Спрашивающий: </dt>
                <dd class="pl-4"><?= isset($fullname) ? $fullname : "" ?></dd>
                <dt class="text-primary"><i class="fas fa-envelope-open-text"></i> Электронная почта: </dt>
                <dd class="pl-4"><?= isset($email) ? $email : "" ?></dd>
                <dt class="text-primary"><i class="fas fa-mobile-alt"></i> Контактный номер: </dt>
                <dd class="pl-4"><?= isset($contact) ? $contact : "" ?></dd>
                <dt class="text-primary"><i class="fas fa-envelope-open"></i> Сообщение: </dt>
