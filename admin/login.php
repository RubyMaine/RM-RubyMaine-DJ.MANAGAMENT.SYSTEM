...
<body class="hold-transition ">
  ...
  <div class="h-100 d-flex align-items-center w-100" id="login">
    <div class="d-flex align-items-center justify-content-center" style="padding-top: 150px;">
      <div class="w-100">
        <center><img src="img/logotype.gif" alt="" id="logo-img"></center>
        <h1 class="text-center py-5 login-title" style="font-size: 2.5em !important;"><b> 𒆜 𝗥𝘂𝗯𝘆𝗠𝗮𝗶𝗻𝗲 — 𝗗𝗝 𒆜 </b></h1>
      </div>
    </div>
      ...
      <div class="d-flex w-100 justify-content-center align-items-center">
        <div class="card col-sm-12 col-md-6 col-lg-3 card-outline card-primary rounded-0 shadow">
          <div class="card-header rounded-0">
            <h4 class="text-purle text-center"><b><i class="fas fa-user-shield"></i> Панель администратора </b></h4>
          </div>
          <div class="card-body rounded-0">
            <form id="login-frm" action="" method="post">
              ...
              <div class="row">
                ...
                <!-- /.col -->
                <div class="col-5">
                  <button type="submit" class="btn btn-success"><i class="fas fa-sign-in-alt"></i> Войти в систему </button>
                </div>
                <!-- /.col -->
              </div>
            </form>
