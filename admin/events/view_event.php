    ...
    <dl>
        ...
        <dd class='pl-4 fs-4 fw-bold'>
            ...
            $status = isset($status) ? $status : 0;
                switch($status){
                    case 0:
                        echo '<span class="badge badge-danger bg-gradient-danger px-3 rounded-pill"> Неактивный </span>';
                        break;
                    case 1:
                        echo '<span class="badge badge-primary bg-gradient-primary px-3 rounded-pill"> Активный </span>';
                        break;
                    default:
