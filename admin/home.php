...
<h1><?php echo $_settings->info('name') ?> — Панель управление </h1>
...
<div class="row">
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-gradient-dark shadow">
            ...
            <span class="info-box-text"> Общее количество событий </span>
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-gradient-dark shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text"> Ежедневные пакеты </span>
            <span class="info-box-number text-right">
                <?php 
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-gradient-dark shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text"> Бронирование </span>
            <span class="info-box-number text-right">
                <?php 
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-gradient-dark shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text"> Непрочитанные запросы </span>
            <span class="info-box-number text-right">
                <?php 
